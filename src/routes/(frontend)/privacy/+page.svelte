...
<Meta {...pageprops} />
<div class="m-5">
	<div class="container prose max-w-5xl dark:prose-invert">
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Aliquant Limited, Chania Avenue, Kilimani,
					Nairobi 0100.
				</p>
			</li>
			<li>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Intuitive Insights, accessible from
					<a href="https://int-insights.com/" rel="external nofollow noopener" target="_blank"
						>https://int-insights.com/</a
					>
				</p>
			</li>
			<li>
		...
		<ul>
			<li>
				<p>By email: info@int-insights.com</p>
			</li>
			<li>
				<p>
					By visiting this page on our website: <a
						href="https://int-insights.com/about#contact"
						rel="external nofollow noopener"
						target="_blank">https://int-insights.com/about#contact</a
					>
				</p>
			</li>
			<li>
				<p>By phone number: +254795057553</p>
			</li>
		</ul>
	</div>
</div>
