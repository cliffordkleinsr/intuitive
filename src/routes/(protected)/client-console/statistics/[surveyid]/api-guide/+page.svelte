			...
			<Tabs.Root value="basic">
				...
				<Tabs.Content value="basic" class="space-y-4">
					...
					<div class="rounded-md bg-muted p-4">
						<code>GET /rest?question=keyboard</code>
					</div>
				</Tabs.Content>
				...
				<Tabs.Content value="pagination" class="space-y-4">
					...
					<div class="rounded-md bg-muted p-4">
						<code>GET /rest?skip=10&limit=5</code>
					</div>
				</Tabs.Content>
				...
				<Tabs.Content value="fuzzy" class="space-y-4">
					...
					<div class="rounded-md bg-muted p-4">
						<code>GET /rest?question=runing</code>
					</div>
				</Tabs.Content>
				...
				<Tabs.Content value="combined" class="space-y-4">
					...
					<div class="rounded-md bg-muted p-4">
						<code>GET /rest?question=shoes&skip=0&limit=2</code>
					</div>
				</Tabs.Content>
			</Tabs.Root>
		</div>
